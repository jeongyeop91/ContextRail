...
Status: completed locally on 2026-08-27. Publication decisions remain outside this implementation plan.
...
- [x] **Step 1: Add a failing foundation contract test**
...
- [x] **Step 2: Run the test and confirm the missing-foundation failure**
...
- [x] **Step 3: Add the minimal self-hosting foundation**
...
- [x] **Step 4: Run the foundation test and structural spot checks**
...
- [x] **Step 1: Write failing document-governance tests**
...
- [x] **Step 2: Run the focused document test**

Run: `node --test test/documents.test.mjs`

Expected: FAIL because validator modules do not exist.

- [x] **Step 3: Implement Markdown and document validation**
...
- [x] **Step 4: Write failing state-contract tests**
...
- [x] **Step 5: Implement state and plan validation**
...
- [x] **Step 7: Run validator tests and self-check**
...
- [x] **Step 1: Write failing scaffold safety tests**
...
- [x] **Step 2: Implement plan-first scaffold operations**
...
- [x] **Step 5: Write failing continue tests**
...
- [x] **Step 6: Implement deterministic continuation**
...
- [x] **Step 7: Wire and test all commands**
...
- [x] **Step 8: Commit the context workflow**
...
- [x] **Step 2: Implement the measurement schema**
...
- [x] **Step 3: Implement local record and report commands**
...
- [x] **Step 4: Run focused tests and a local smoke**
...
- [x] **Step 5: Commit measurement support**
...
- [x] **Step 1: Generate and inspect the reproducible patch**
...
- [x] **Step 4: Write failing preparation tests with a local fake upstream**
...
- [x] **Step 5: Implement safe preparation**
...
- [x] **Step 6: Run local fixture tests and real-source dry run**
...
- [x] **Step 7: Commit provenance and preparation**
...
- [x] **Step 1: Write failing install safety tests**
...
- [x] **Step 2: Implement versioned managed installation**
...
- [x] **Step 3: Write failing verification tests**
...
- [x] **Step 4: Implement verification adapters**
...
- [x] **Step 5: Implement guarded rollback**
...
- [x] **Step 6: Run temporary-HOME integration tests and current-host read-only verify**
...
- [x] **Step 7: Commit installation support**
...
- [x] **Step 1: Write the user-facing workflows**
...
- [x] **Step 4: Review scope, secrets, paths, and licenses**
...
- [x] **Step 5: Finalize project memory**
...
- [x] **Step 6: Run verification after memory finalization**

Run: `npm run verify`

Expected: all tests, self-validation, generated-template smoke, and diff checks PASS.

- [x] **Step 7: Commit the release-ready local state**
